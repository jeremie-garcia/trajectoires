...
interfaceJS =  fs.readFileSync( pathModule.normalize('../zepto.js'), ['utf-8'] );
interfaceJS += fs.readFileSync( pathModule.normalize('../interface.js'), ['utf-8'] );
interfaceJS += fs.readFileSync( pathModule.normalize('./interface.client.js'), ['utf-8'] );
