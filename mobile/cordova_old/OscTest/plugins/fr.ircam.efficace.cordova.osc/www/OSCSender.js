...
OSCSender.prototype.sendnodouble = function(address, data, successCallback, errorCallback){
	...
	cordova.exec(successCallback, errorCallback, "OSC", "sendMessageNoDouble", data);
}
